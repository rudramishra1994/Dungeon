...
/**
 * This interface represents all the operations that a binary search tree should support. It can
 * store any type of data that implements the Comparable interface
 *
...
public interface BinarySearchTree<T extends Comparable<T>> {
  ...
  /**
   * Returns a string that present all the data in the tree, sorted in ascending order. The string
  ...
  /**
   * Returns a string that present all the data in the tree in pre-order. sorted in ascending order.

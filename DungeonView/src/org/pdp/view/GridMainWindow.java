...
public class GridMainWindow extends JFrame implements IGameMainView {
  ...
  public void updatePlayerStatusBoard(StringBuilder info) {
    if (info == null) {
      throw new IllegalArgumentException("Player info cannot be null");
    }
  ...
  public void updateLocationStatusBoard(StringBuilder info) {
    if (info == null) {
      throw new IllegalArgumentException("Location info cannot be null");
    }
  ...
  public void setGameFeatures(GameFeatures feature) {
    if (feature != null){
      this.gameFeatures = feature;
    } else {
        throw new IllegalArgumentException("Game Features cannot be null");
    }
  ...
  public void resetGridOnNewGame() {
    ...
    //masterPanel.repaint();
    this.resetGameFeatures(this.gameFeatures);
  }

  private void resetGameFeatures(GameFeatures gameFeatures) {
    MouseAdapter clickAdapter = new MouseAdapter() {
      @Override
      public void mouseReleased(MouseEvent e) {
        super.mouseClicked(e);
        if  (!(dungeon.hasReachedGoal())) {
          GridCellPanel cell = (GridCellPanel) e.getComponent();
          gameFeatures.movePlayer(cell.getGridRow(), cell.getGridColumn());
        }
      }
    };
